...
Vr_linha = Complexo.ProdutoComplexa(Complexo.Rect(math.sqrt(3),0),Vr)


print('Foram calculados: \n'
      f'    - |Vs_linha| = {Vs_linha.mod/10**3} kV\n'
...
Sr = Complexo.ProdutoComplexa(Vr, ir_conj)
Pmono_recept = Sr.rect.real
Qmono_recept = Sr.rect.imag
Ptri_recept = 3*Pmono_recept
Qtri_recept = 3*Qmono_recept
...
print('Calculando o Fluxo de Potência, temos: \n'
      ...
      f'    - P_trifasica_receptor = {Ptri_recept/10**6} MW\n'
      f'    - Q_trifasica_receptor = {Qtri_recept/10**6} Mvar\n'
      f'    - Rendimento = {rend} %\n'
      , end='\n \n')
...
Reg = Complexo.DivisaoComplexa(Vs_linha, A)
Reg = Complexo.SubtracaoComplexa(Reg, Vr_linha)
Reg = Complexo.DivisaoComplexa(Reg,Vr_linha)
Reg = Reg.mod * 100

Ferranti = Vs_linha.mod/Vr_linha.mod
